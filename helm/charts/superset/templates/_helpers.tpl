...
# overriding config
APP_NAME=env('APP_NAME', 'Superset')
ENABLE_CORS=True
...
FEATURE_FLAGS: dict[str, bool] = {"ALERT_REPORTS": True, "EMBEDDED_SUPERSET": True}
FAVICONS=[{"href": env('FAVICONS', '/static/assets/images/favicon.png')}]
APP_ICON=env('APP_ICON', '/static/assets/images/superset-logo-horiz.png')
